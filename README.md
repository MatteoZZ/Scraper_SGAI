...
## Scrapers portali (ADM, Italgiure, EUR-Lex, Curia, Massimario, EBTI, MEF modulo)

Cartelle sotto `scripts/scraper_*` — codice per scaricare (senza sentenze già scaricate).  
Guida: [SCRAPERS.md](SCRAPERS.md) · dipendenze: `requirements-scrapers.txt`
...
# Download sentenze MEF (worker Opera/Edge)
